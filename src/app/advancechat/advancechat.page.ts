...
@Component({
  selector: 'app-advancechat',
  templateUrl: './advancechat.page.html',
  styleUrls: ['./advancechat.page.scss'],
})
export class AdvancechatPage  {
...
minutes;
  ...
  getMsg(){
    ...
    this.db.list('/advancechat').valueChanges()
    .subscribe((datas) => {
