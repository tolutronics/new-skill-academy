...
@Component({
  ...
  styleUrls: ['./intermediatechat.page.scss'],
})
export class IntermediatechatPage  {
  username={} as any;
  message;
  key:any;
  time:any;
...
minutes;
  ...
  getMsg(){
    ...
    this.db.list('/intermediatechat').valueChanges()
    .subscribe((datas) => {
...
getData(){
  ...
  this.time = this.hours + ':' + this.minutes + ' ' + ampm;
    ...
    //       console.log("keypath"+ this.keypath);
          this.db.list(`/intermediatechat`).push({
